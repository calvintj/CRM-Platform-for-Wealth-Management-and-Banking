...
import useGetActivity from "../../hooks/customerDetails-hooks/getActivity"; // Custom hook to fetch tasks
import usePostActivity from "../../hooks/customerDetails-hooks/postActivity"; // Custom hook to post a new task
